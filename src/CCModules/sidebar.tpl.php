...
<div class='box'>
<h4>Tube CMF</h4>
<p>Tube Content Management Framework (CMF) modules.</p>
<ul>
<?php foreach($modules as $module): ?>
...
<div class='box'>
<h4>More modules</h4>
<p>Modules that does not implement any specific Tube interface.</p>
<ul>
<?php foreach($modules as $module): ?>
