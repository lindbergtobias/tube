<?php
/**
 * Main class for Tube, holds everything.
 *
 * @package Tube
 */
class CTube implements ISingleton {
  ...
  /**
	 ...
	 * @return CTube The instance of this class.
	 */
  ...
  public function ThemeEngineRender() {
    ...
    $themePath 	= TUBE_INSTALL_PATH . '/' . $this->config['theme']['path'];
    ...
    if(isset($this->config['theme']['parent'])) {
      $parentPath = TUBE_INSTALL_PATH . '/' . $this->config['theme']['parent'];
    ...
    // Extract $tube->data to own variables and handover to the template file
  ...
  /**
   * Draw HTML for a menu defined in $tube->config['menus'].
   *
